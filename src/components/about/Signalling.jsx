...
const Signalling = ({ currentLanguage }) => {
    ...
    const fetchData = async () => {
        try {
            let url = `${apiUrl}/api/horizontal-and-vertical-signallings?populate=*`;
    ...
    return (
        <div className='absolute top-0 lg:px-8 w-full h-full flex items-center lg:justify-end overflow-x-auto'>
            <div className="inline-block min-w-full shadow-sm rounded-lg">
                <p className='font-custom text-3xl 2xl:text-4xl text-white rounded-md bg-[#313232] uppercase bg-opacity-75 p-3 2xl:py-10'>
                    {currentLanguage === "en"
                    ...
                    <tbody>
                        {currentProjects?.map(project => (
                            <tr key={project.id} className='font-custom1 text-white'>
                                ...
                                <td className="text-center lg:text-left border lg:px-4 py-2 text-sm lg:text-base 2xl:text-lg">
                                    {currentLanguage === "en"
                                ...
                                <td className="text-center lg:text-left border lg:px-4 py-2 text-sm lg:text-base border-r-0 2xl:text-lg">
                                    {currentLanguage === "en"
